...
namespace QuizApp.Migrations
{
    ...
    [Migration("20240523114312_Initial")]
            ...
            modelBuilder.Entity("QuizApp.Models.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 5, 23, 17, 13, 12, 499, DateTimeKind.Local).AddTicks(5906),
                            NumOfQuestions = 2,
                            QuizCreatedBy = 101,
            ...
            modelBuilder.Entity("QuizApp.Models.FillUps", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 202,
                            Category = "Science",
                            CreatedDate = new DateTime(2024, 5, 23, 17, 13, 12, 499, DateTimeKind.Local).AddTicks(5873),
                            DifficultyLevel = 1,
                            Points = 15m,
            ...
            modelBuilder.Entity("QuizApp.Models.MultipleChoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 201,
                            Category = "Geography",
                            CreatedDate = new DateTime(2024, 5, 23, 17, 13, 12, 499, DateTimeKind.Local).AddTicks(5819),
                            DifficultyLevel = 0,
                            Points = 10m,
                            QuestionCreatedBy = 101,
            ...
            modelBuilder.Entity("QuizApp.Models.UserDetails", b =>
                {
                    b.HasOne("QuizApp.Models.User", "User")
                        .WithOne("UserDetails")
                        .HasForeignKey("QuizApp.Models.UserDetails", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
